...
##########################################################
    ...
    if genre:
        popular_movies = movies[['movie_title','genres']]
    else:
        popular_movies = movies[['movie_title']]
...
##########################################################
    ...
    if recommend_button:
        #  AgGrid(df_rec[['title','genres']].head())
        st.write(
            HTML(df_rec[['movie_title','genres']].head().to_html(escape=False))
            )
